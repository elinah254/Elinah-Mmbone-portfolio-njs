  ...
  const services: Service[] = [
    {
      ...
      description:
        "Modern, responsive, and accessible interfaces that bring Figma designs to life with precision.",
    ...
    },
    {
      ...
      description:
        "Scalable server-side solutions with secure APIs and efficient database design.",
    ...
    },
    {
      ...
      description:
        "Seamless integration of third-party APIs to extend functionality and improve workflows.",
