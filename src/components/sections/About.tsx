  ...
  const passions = [
    {
      ...
      description:
        "Ensuring seamless experiences across desktops, tablets, and mobile devices.",
    },
    {
      icon: <Palette className="w-6 h-6 text-purple-400" />,
      title: "UI Implementation",
      description:
        "Translating Figma and design concepts into pixel-perfect interfaces.",
    },
    {
      icon: <Zap className="w-6 h-6 text-yellow-400" />,
      title: "Performance Optimization",
      description:
        "Improving load times and smooth interactions for better user engagement.",
    },
    {
      icon: <Accessibility className="w-6 h-6 text-green-400" />,
      title: "Accessibility",
      description:
        "Building inclusive web apps that everyone can navigate with ease.",
    },
  ];
