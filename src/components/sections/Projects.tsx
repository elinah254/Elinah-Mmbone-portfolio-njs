	...
	const projects: Project[] = [
		{
			...
			liveUrl: "https://clutter-haven.pipeops.net/",
			category: "frontend",
		},
		{
			id: "2",
		...
		},
		{
			...
			title: "Mindcare Hub",
			description:
				"A mental health hub providing resources and support, built with React and Tailwind.",
			technologies: ["React", "Tailwind", "CSS"],
			imageUrl: "/images/Mindcare-hub.png",
			// githubUrl: "https://github.com/elinah254/Mindcare-Hub-React",
			liveUrl: "https://mindcare-hub.pipeops.net/",
			category: "frontend",
		},
		{
			id: "4",
